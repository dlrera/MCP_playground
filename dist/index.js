...
server.setRequestHandler(CallToolRequestSchema, async (request) => {
    ...
    try {
        switch (name) {
            case 'create_task':
                return await omniFocusTools.createTask(args);
            case 'create_project':
                return await omniFocusTools.createProject(args);
            case 'list_projects':
                return await omniFocusTools.listProjects(args);
            case 'list_tasks':
                return await omniFocusTools.listTasks(args);
            case 'complete_task':
                return await omniFocusTools.completeTask(args);
            case 'search_tasks':
                return await omniFocusTools.searchTasks(args);
            case 'edit_task':
                return await omniFocusTools.editTask(args);
            case 'move_task':
                return await omniFocusTools.moveTask(args);
            case 'edit_project':
                return await omniFocusTools.editProject(args);
            case 'delete_task':
                return await omniFocusTools.deleteTask(args);
            case 'delete_project':
                return await omniFocusTools.deleteProject(args);
            case 'create_context':
                return await omniFocusTools.createContext(args);
            case 'list_contexts':
                return await omniFocusTools.listContexts(args);
            case 'set_task_flag':
            ...
            case 'get_folder_details':
                return await omniFocusTools.getFolderDetails(args);
            case 'list_tags_hierarchy':
                return await omniFocusTools.listTagsHierarchy(args);
